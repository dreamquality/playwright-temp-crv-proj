...
test('Verify 25 CV limit for parsing without formatting', async ({ cvReformatterUploadPage, validationPage }) => {
  await cvReformatterUploadPage.pageIsOpened(firstName)

  await cvReformatterUploadPage.uploadAmountOfCVs(filePath,25);
