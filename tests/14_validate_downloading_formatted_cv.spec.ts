...
test('Validate formatted CV downloading', async ({ cvReformatterUploadPage, cvReformatterFormatPage, validationPage }) => {
  await cvReformatterUploadPage.pageIsOpened(firstName)
  await cvReformatterUploadPage.downloadFirstFormattedCV()
